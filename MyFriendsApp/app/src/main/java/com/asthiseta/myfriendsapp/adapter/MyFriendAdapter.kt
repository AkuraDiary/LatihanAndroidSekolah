...
class MyFriendAdapter(private val context : Context, private val myFriendList : ArrayList<MyFriend>) : RecyclerView.Adapter<MyFriendAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        var txtFriendPhone : TextView = itemView.findViewById(R.id.txtFriendTelp)
